...
public class MultiplicadorActividadesHistorial extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.multiplicador_actividades2);
    ...
    public void actualizarMinutos(View view){
    	double k30m=Double.parseDouble(km);
        double kminutos=k30m/30;
