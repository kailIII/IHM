 ...
 */
public class CatalogoActividadProvider extends ContentProvider {
    public static final String PROVIDER_NAME = "effectiveRutine.proveedor.CatalogoActividad";
    public static final String ENTIDAD = "catalogo_actividad";
    ...
    public static final String DESCRIPCION = "decripcion";
    
    public static final int CATALOGOS_ACTIVIDAD = 1;
    public static final int CATALOGOS_ACTIVIDAD_ID = 2;
    
    public static final UriMatcher uriMatcher;
    static{
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI(PROVIDER_NAME, ENTIDAD, CATALOGOS_ACTIVIDAD);
        uriMatcher.addURI(PROVIDER_NAME, ENTIDAD+"/#", CATALOGOS_ACTIVIDAD_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if(uriMatcher.match(uri) == CATALOGOS_ACTIVIDAD_ID)
