...
public class AlimentoProvider extends ContentProvider{
    public static final String PROVIDER_NAME = "effectiveRutine.proveedor.Alimento";
    public static final String ENTIDAD = "alimento";
    ...
    public static final String _ID = "id_alimento";
    public static final String NOMBRE = "nombre";
    public static final String DESCRIPCION = "descipcion";
    public static final String CANTIDAD_G = "cantidad_g";
    ...
    public static final int ALIMENTOS = 1;
    public static final int ALIMENTO_ID = 2;
    
    public static final UriMatcher uriMatcher;
    static{
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI(PROVIDER_NAME, ENTIDAD, ALIMENTOS);
        uriMatcher.addURI(PROVIDER_NAME, ENTIDAD+"/#", ALIMENTO_ID);
    }
