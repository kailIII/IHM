 ...
 */
public class ActividadProvider extends ContentProvider {
    public static final String PROVIDER_NAME = "effectiveRutine.proveedor.Actividad";
    public static final String ENTIDAD = "actividad";
    ...
    public static final String _ID = "id_actividad";
