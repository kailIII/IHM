 ...
 */
public class DetalleRutinaActividadProvider extends ContentProvider {
    public static final String PROVIDER_NAME = "effectiveRutine.proveedor.DetalleRutinaActividad";
    public static final String ENTIDAD = "detalle_rutina_actividad";
    ...
    public static final String ID_RUTINA_ACTIVIDAD = "id_rutina_actividad";
    public static final String ID_ACTIVIDAD = "id_actividad";
    public static final String DURACION_S = "duracion_s";
    public static final String CALORIAS_KCAL = "calorias_kcal";
    
    public static final int DETALLES_RUTINA_ACTIVIDAD = 1;
    public static final int DETALLES_RUTINA_ACTIVIDAD_ID = 2;
    
    public static final UriMatcher uriMatcher;
    static{
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI(PROVIDER_NAME, ENTIDAD, DETALLES_RUTINA_ACTIVIDAD);
        uriMatcher.addURI(PROVIDER_NAME, ENTIDAD+"/#", DETALLES_RUTINA_ACTIVIDAD_ID);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if(uriMatcher.match(uri) == DETALLES_RUTINA_ACTIVIDAD_ID)
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case DETALLES_RUTINA_ACTIVIDAD:
                return "vnd.android.cursor.dir/vnd.effectiveRutine."+ENTIDAD;
            case DETALLES_RUTINA_ACTIVIDAD_ID:
